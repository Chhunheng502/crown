    ...
    <app-layout title="Chat">
        <section-layout>
            ...
            <template #section-middle>
                <div v-show="hasExistingChat()" class="flex-1 p:2 sm:p-6 justify-between flex flex-col h-screen border-2 border-gray-300 rounded-lg">
            ...
            <template #section-right>
                <chat-setting :user="to_user"> </chat-setting>
            </template>
        </section-layout>
    </app-layout>
</template>
