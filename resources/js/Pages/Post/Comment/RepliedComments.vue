<template>
    <div class="flex space-x-2">
        ...
        <div v-show="!viewEdit" class="w-full">
            <div class="flex items-center space-x-2">
                ...
                <popover v-show="user.id === comment.replier.id" popoverClass="rounded-full w-8 h-8 hover:bg-gray-300">
                    ...
                    <template #items>
                        ...
                        <div>
                            <button type="button" class="w-full px-4 py-2 hover:bg-gray-300" @click="viewEdit = true"> Edit </button>
                        </div>
                        <div>
                            <button type="button" class="w-full px-4 py-2 hover:bg-gray-100" @click="deleteComment"> Delete </button>
                        </div>
                    </template>
                </popover>
            </div>
            ...
            <form v-show="replyClicked && (user.id !== comment.replier.id)" class="flex mt-2 space-x-2 items-center" @submit.prevent="replyComment">
