                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden sm:flex sm:items-center sm:ml-6">
                                <div class="ml-3 relative">
                                    <notifications :userID="$page.props.user.id"> </notifications>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ml-6">
                            ...
                            <div class="relative mx-auto text-gray-600 lg:block hidden" v-on:click="showModal = true">
                                ...
                                >
                                <button type="button" class="absolute right-0 top-1/2 -translate-y-1/2 mr-2"> <i class="fas fa-search"></i> </button>
                            ...
                            <div class="ml-3 relative">
                                <jet-dropdown align="right" width="48">
                                    ...
                                    <template #content>
                                        ...
                                        <jet-dropdown-link :href="'profiles?' + 'search=' + $page.props.user.name">
                                            Profile
                                        </jet-dropdown-link>

                                        <jet-dropdown-link :href="route('profile.setting')">
                                            Settings
                                        </jet-dropdown-link>
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                    ...
                    <div class="pt-4 pb-1 border-t border-gray-200">
                        ...
                        <div class="mt-3 space-y-1">
                            <jet-dropdown-nav-link :href="'profiles?' + 'search=' + $page.props.user.name">
                                Profile
                            </jet-dropdown-nav-link>

                            <jet-responsive-nav-link :href="route('profile.setting')" :active="route().current('profile.setting')">
                                Setting
                            </jet-responsive-nav-link>
