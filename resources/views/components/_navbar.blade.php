...
<nav class="flex items-center justify-between flex-wrap bg-gray-600 p-6">
    ...
    <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
      <div class="text-sm lg:flex-grow">
        ...
        <a href="{{ route('chat.index') }}" class="block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white mr-4">
          Chats
        </a>
      ...
      <div class="flex space-x-2">
          ...
          <input type="text" name="search" id="search" class="px-3 py-2" placeholder="Search Crown">
      </div>
    </div>
</nav>