...
use App\Models\User;
use App\Notifications\FriendRequest as FriendRequestNotifications;
...
class FriendshipController extends Controller
{
    ...
    public function addFriend(Request $request)
    {
        ...
        Notification::send(User::find($request->to_user_id), new FriendRequestNotifications(Auth::user()));
    ...
    {
        return FriendRequest::with('requester')
